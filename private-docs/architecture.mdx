...
import DiagramModalViewer from '@site/src/components/DiagramModalViewer';
import NonInteractiveSchemaDiagram from '@site/src/components/NonInteractiveSchemaDiagram';
import InteractiveSchemaDiagram from '@site/src/components/InteractiveSchemaDiagram';
...
<Tabs>
    <TabItem value="non-interactive" label="Non-Interactive">
        The below diagram indicates high-level entity relationships within the database schema.
        <DiagramModalViewer>
            <NonInteractiveSchemaDiagram />
        </DiagramModalViewer>
    </TabItem>
    <TabItem value="interactive" label="Interactive">
        You can also explore the schema relationships using the interactive diagram below.
        <DiagramModalViewer>
